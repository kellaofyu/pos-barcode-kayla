    ...
    $sql = "SELECT * FROM tb_user WHERE username='$username'AND password='$password'";
        ...
        if(is_array($row)){
            if($row['username']==$username AND $row['password']==$password AND $row['role']=='admin'){
                ...
                echo $notif = "<div class=\"alert alert-success coll-md-12\"sytle=\"max-width:24%; flex:unset\">Berhasil Login </div>";
                ...
                echo $notif = "<div class=\"alert alert-danger coll-md-12\"sytle=\"max-width:24%; flex:unset\">Berhasil Login </div>";
                header('refresh: 2:view/dashboard/operator_dashboard.php');
            }
        }else{
            echo $notif = "<div class=\"alert alert-danger coll-md-12\"sytle=\"max-width:24%; flex:unset\">Username / Password Salah </div>";
        }
    }
