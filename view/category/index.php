...
if (isset($_POST['submit'])) {
  ...
  if (empty($kat_name)) {
    ...
    $insert = $pdo->prepare("INSERT INTO tb_kategori (nm_cat) value(:cat)");
            ...
            <div class="card-body">
              <div class="d-flex justify-content-between mb3">
                ...
                <div class="form-group row">
                  <label for="search" class="col-sm-4 font-weight-normal col-form-label" style="font-size: 16px;">Pencarian :</label>
                  <div class="col">
              ...
              <table id="example1" class="table table-bordered table-hover" style="width: 100%;">
                <thead>
                  <th class="sorting sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="No: activate to sort column descending">No
                  </th>
                  <th class="sorting sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Nama: activate to sort column descending">Nama
                  </th>
              ...
              <div class="row">
                <div style="width: 200%;" class="col-sm-10 col-md-5">
                  <div class="dataTables_info" id="example1_info" role="status" aria-live="polite">Menampilkan 1 dari 1 halaman</div>
                </div>
